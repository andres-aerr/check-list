...
export const LoginPage = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const userCard = quickAccessCards.find(
      (card) => card.email === formData.email
    );
  ...
  const redirectBasedOnRole = (role: string) => {
    switch (role) {
      case "admin":
        navigate("/admin/dashboard"); // Los administradores van al panel de administración
        break;
      case "contract_admin":
            ...
            <ul className='space-y-2 text-sm'>
              <li className='p-2 bg-red-50 rounded border-l-4 border-red-500'>
                ...
                <span className='text-xs text-gray-600 mt-1'>
                  ...
                  checklists y ver todos los reportes.
                </span>
              </li>
              <li className='p-2 bg-purple-50 rounded border-l-4 border-purple-500'>
                ...
                <span className='text-xs text-gray-600 mt-1'>
                  Puede gestionar checklists y ver reportes, pero no puede
              ...
              <li className='p-2 bg-green-50 rounded border-l-4 border-green-500'>
                ...
                <span className='text-xs text-gray-600 mt-1'>
                  Acceso básico. Puede completar checklists asignados y ver el
                  dashboard.
                </span>
              </li>
            </ul>
